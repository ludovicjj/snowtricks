 ...
 */
final class Version20181218034401 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lj_comment CHANGE trock_id trick_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lj_comment CHANGE trick_id trock_id CHAR(36) DEFAULT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:uuid)\'');
